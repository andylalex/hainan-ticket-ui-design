                        ...
                        <ul>
                            ...
                            <li>支付方式：支持4种支付方式组合使用
                                <ul>
                                    ...
                                    <li>充值卡支付：支持多选充值卡组合支付，显示每张卡的余额和卡号；已全额抵扣后不可继续选择新卡；实际抵扣金额为min(已选卡总额, 应付-其他已抵扣)</li>
                ...
                <ul>
                  ...
                  <li><strong>功能实现逻辑：</strong>
                    <ul>
                      ...
                      <li>费用明细区：在"实付金额"上方增加"支付明细"折叠区，默认折叠，点击展开显示各支付方式（微信/钱包/充值卡）及金额，带对应颜色图标；积分抵扣作为费用明细行显示在优惠券抵扣下方（与优惠券相同样式）</li>
